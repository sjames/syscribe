...
## Running the validator against the model

```bash
cargo run --package syscribe -- model/
```

The report covers all 115 elements, the full requirements traceability matrix, and any validation findings. The model should produce zero errors.
