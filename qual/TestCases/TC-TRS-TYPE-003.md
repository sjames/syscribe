...
Verify ConcernDef and Concern are recognised and validated without E005.

```gherkin
Feature: Element type recognition — ConcernDef, Concern

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: ConcernDef, Concern
