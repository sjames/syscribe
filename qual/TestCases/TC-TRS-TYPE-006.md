...
testLevel: L3
status: draft
title: "Verify AnalysisCase is recognised and validated without E005."
verifies:
  - REQ-TRS-TYPE-006
---

Verify AnalysisCase is recognised and validated without E005.

```gherkin
Feature: Element type recognition — AnalysisCase

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: AnalysisCase
