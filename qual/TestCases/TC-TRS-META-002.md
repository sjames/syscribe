...
testLevel: L3
status: draft
title: "Verify diagrams render applied MetadataDef stereotypes as «Name» banners: a stereotyped element shows «Critical» in addition to its type-keyword banner; an element with no application shows no spurious banner."
verifies:
  - REQ-TRS-META-002
---
