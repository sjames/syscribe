...
testLevel: L3
status: draft
title: "Verify RenderingDef is recognised and validated without E005."
verifies:
  - REQ-TRS-TYPE-011
---

Verify RenderingDef is recognised and validated without E005.

```gherkin
Feature: Element type recognition — RenderingDef

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: RenderingDef
