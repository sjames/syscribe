...
Verify VerificationCase is recognised and validated without E005.

```gherkin
Feature: Element type recognition — VerificationCase

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: VerificationCase
