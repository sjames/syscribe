...
Verify SuccessionDef is recognised and validated without E005.

```gherkin
Feature: Element type recognition — SuccessionDef

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: SuccessionDef
