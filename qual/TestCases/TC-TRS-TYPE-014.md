...
Verify BindingConnector is recognised and validated without E005.

```gherkin
Feature: Element type recognition — BindingConnector

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: BindingConnector
