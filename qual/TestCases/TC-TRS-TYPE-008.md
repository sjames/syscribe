...
Verify UseCase is recognised and validated without E005.

```gherkin
Feature: Element type recognition — UseCase

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: UseCase
