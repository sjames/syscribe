...
testLevel: L3
status: draft
title: "Verify CaseDef is recognised and validated without E005."
verifies:
  - REQ-TRS-TYPE-005
---

Verify CaseDef is recognised and validated without E005.

```gherkin
Feature: Element type recognition — CaseDef

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: CaseDef
