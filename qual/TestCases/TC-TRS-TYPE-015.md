...
testLevel: L3
status: draft
title: "Verify LibraryPackage and Namespace are recognised and validated without E005."
verifies:
  - REQ-TRS-TYPE-015
---

Verify LibraryPackage and Namespace are recognised and validated without E005.

```gherkin
Feature: Element type recognition — LibraryPackage, Namespace

  Scenario: Declared types are recognised and validate clean
    Given a minimal valid model containing one element of each of: LibraryPackage, Namespace
