...
**Acceptance criteria:** `id: ADR-SYS-001` passes; `id: ADR-001` (no category segment) also passes, since the category segment(s) before the numeric suffix are optional; `id: ADR-sys-001` produces `E300`; absent `id:` produces `E301`.
